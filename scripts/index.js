...
tl.to("#open-eye-bottom", .05, {morphSVG:{shape:"#closed-eye-bottom"}, shapeIndex:22, ease:Power3.easeIn}, 0)
  ...
  .to("#open-eye-top", .05, {morphSVG:{shape:openEyeTop}, shapeIndex:2, ease:Power3.easeIn}, 0.2)
  .to("#open-eye-bottom", .05, {morphSVG:{shape:openEyeBottom}, shapeIndex:2, ease:Power3.easeIn}, 0.2)
